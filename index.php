...
<div class="clearfix">
  <div id="mobile" class="audio_list_mobile">
	...
	<button class="audio_name" value="1">A Case of Identity - Sir Arthur Conan Doyle</button>
      <button class="audio_name" value="2">Achin Pakhi - Byomkesh</button>
      <button class="audio_name" value="3">Ashchorjontu - Satyajit Roy</button>
      <button class="audio_name" value="4">Badsahi Angti - Satyajit Ray
</button>
      <button class="audio_name" value="5">Brindaboney Bibhishon - Prokhor Rudra</button>
      <button class="audio_name" value="6">Bhog - Aveek Sarkar</button>
      <button class="audio_name" value="7">Ayna - Nityananda Khan</button>
      <button class="audio_name" value="8">Agniban - Byomkesh</button>
    </div>
      </div>
...
<div style="height:300px;position:relative;">
    <img id="aud_img" src="home_audio/audio_images/A Case of Identity.png" style="height:300px; width:100%;" alt="image"><br>
    <marquee class="info" scrolldelay="5" scrollamount="4">A Case of Identity - Sir Arthur Conan Doyle</marquee>
</div>
<div style="height: 168px;">
  <audio id="player" src="home_audio/A Case of Identity.mp3"></audio>
  <div class="player">
