...
<h3>MOST POPULAR STORIES</h3>
  ...
  <div style="height:300px;position:relative;">
    <img id="aud_img" src="home_audio/audio_images/Bhog - Aveek Sarkar.png" style="height:300px; width:100%;" alt="image"><br>
    <marquee class="info" scrolldelay="5" scrollamount="4">Bhog - Aveek Sarkar</marquee>
</div>
<div style="height: 168px;">
  <audio id="player" src="home_audio\Bhog - Aveek Sarkar.mp3"></audio>
